 ...
 *   A form array.
 */
function danytheme_settings($saved_settings) {

  // Get the default values from the .info file.
  $defaults = zen_theme_get_default_settings('danytheme');
   ...
   */
  $form = array();
  $form['danytheme_fixed'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use fixed width for theme'),
    '#default_value' => $settings['danytheme_fixed'],
  ...
  $form['danytheme_design'] = array(
    '#type'          => 'radios',
    '#title'         => t('Design'),
    '#default_value' => $settings['danytheme_design'],
    '#options'       => array(
      '0' => t('Teal and Orange'),
      '1' => t('Blue and Green'),
      '2' => t('Red and Gray'),
  ...
  $form['danytheme_font_family'] = array(
    '#type'          => 'radios',
    '#title'         => t('Font Family'),
    '#default_value' => $settings['danytheme_font_family'],
    '#options'       => array(
  ...
  $form['danytheme_color1'] = array(
    ...
    '#default_value' => $settings['danytheme_color1'],
  ...
  $form['danytheme_color2'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for header and footer backgrounds'),
    '#default_value' => $settings['danytheme_color2'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
  );

 $form['danytheme_color3'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for main navigation bar and block header backgrounds'),
    '#default_value' => $settings['danytheme_color3'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
  );

  $form['danytheme_color4'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for block content background'),
    '#default_value' => $settings['danytheme_color4'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
  );

  $form['danytheme_color5'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for links'),
    '#default_value' => $settings['danytheme_color5'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
    '#prefix'        => t('<b>TEXT COLORS</b>')
  );

  $form['danytheme_color6'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for site name, site slogan and footer text'),
    '#default_value' => $settings['danytheme_color6'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
  );

  $form['danytheme_color7'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for primary menu links and block headers'),
    '#default_value' => $settings['danytheme_color7'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
  );

    $form['danytheme_color8'] = array(
    '#type'          => (module_exists('colorpicker') ? 'colorpicker_' : '') . 'textfield',
    '#title'         => t('Select color for secondary menu links'),
    '#default_value' => $settings['danytheme_color8'],
    '#description'   => t('Click on the eyedropper icon to use color picker.  Or enter an HTML color code.'),
    '#suffix'        => '</div></fieldset>',
  );
